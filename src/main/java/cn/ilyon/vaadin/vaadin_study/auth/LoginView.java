package cn.ilyon.vaadin.vaadin_study.auth;
...
public class LoginView extends CssLayout implements View{
   ...
   @Inject @Default private  UserService userService;
    ...
    private Component buildLoginForm() {
        ...
        loginForm.setData(user);
        loginForm.addComponent(username = new TextField("Username",user.getUserName()));
...
//         username.focus();
    	Page.getCurrent().setLocation("user");
